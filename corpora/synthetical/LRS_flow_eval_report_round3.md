...
| FLOW output   | `Weil es morgens so geregnet hat, sind wir in der pause trotzdem raus und danach waren meine socken ganz kalt und matschig.` |
...
- `PG:/\bsoken\b/` — \bsoken\b
  - Änderung: `soken`→`socken`
